...
#[ffi_type]
#[repr(C)]
// Wrapper for TXid modified from wrapperid
...
pub fn my_inventory() -> Inventory {
    {
        InventoryBuilder::new()
            ...
            .register(extra_type!(TxIdWrapper))
            .register(extra_type!(SegmentWrapper))
            .register(extra_type!(ScopedSegmentWrapper))
            .register(extra_type!(SegmentMetadataClient))
        .inventory()
    }
}